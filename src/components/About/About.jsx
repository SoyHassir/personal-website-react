        ...
        <div className='about-main'>
          <div className='about-content slide-in-left'>            
            <div className='about-description'>
              ...
              <p>
                Soy doctor en Planeación Estratégica y Dirección de Tecnología, y también en 
                Economía y Empresa, con una maestría en Administración Estratégica y una base sólida 
                como Administrador de Empresas. Actualmente, como profesor-investigador reconocido 
                por <a href="https://scienti.minciencias.gov.co/cvlac/visualizador/generarCurriculoCv.do?cod_rh=0001630270" target="_blank" rel="noopener" className="cvlac-link">MinCiencias</a> y analista de datos, acompaño de cerca los procesos de transformación y crecimiento.
              </p>
              <p>
